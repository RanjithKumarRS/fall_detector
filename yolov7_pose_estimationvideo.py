...
# token1 = '6020596830:AAFndjzcqpbOYyKYQEBU8rq2bhEMHUmIjYw' # telegram token 
token = '6201958741:AAHk3xKztfXPmykYY61vD3bTgvUxjXHlcuw' # telegram token
# receiver_id1 =1697455783 # https://api.telegram.org/bot<TOKEN>/getUpdates
# receiver_id2 =6201958741 # https://api.telegram.org/bot<TOKEN>/getUpdates
receiver_id =1140619473 # https://api.telegram.org/bot<TOKEN>/getUpdates
# bot1 = telepot.Bot(token1)
bot = telepot.Bot(token)

device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
weigths = torch.load('yolov7-w6-pose.pt', map_location=torch.device('cpu'))
    ...
    if ret:
        ...
        for idx in range(output.shape[0]):
            ...
            #Plotting key points on Image
              ...
              # url = "https://api.telegram.org/bot6020596830%3AAAFndjzcqpbOYyKYQEBU8rq2bhEMHUmIjYw/sendMessage"

              # payload = {
              #       "text": "Person Fall Detected",
              #       "parse_mode": "Markdown",
              ...
              num = random.random()
              filename = "D:\\project\\savedImage"+str(num)+".jpg"
        ...
        #     breakD:\project\yolov7-w6-pose.pt
    else:
        break
